...
project_name     = 'vara-jb'
trigger_branches = 'vara-dev-jb|vara-llvm-dev-jb|vara-clang-dev-jb'
uchroot_src_root = '/mnt/vara-llvm-jb'
checkout_base_dir = '%(prop:builddir)s/vara-llvm-jb'

repos = {
    'vara-llvm': {
        'default_branch': 'vara-llvm-dev-jb',
        'checkout_dir': checkout_base_dir,
    },
    'vara-clang': {
        'default_branch': 'vara-clang-dev-jb',
        'checkout_dir': checkout_base_dir + '/tools/clang',
    },
    'vara': {
        'default_branch': 'vara-dev-jb',
