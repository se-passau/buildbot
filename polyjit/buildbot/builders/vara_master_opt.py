...
REPOS['vara'] = {
    ...
    'checkout_dir': CHECKOUT_BASE_DIR + '/vara-llvm-project',
    'checkout_subdir': '/vara-llvm-project',
}
...
def configure(c):
    ...
    for step in get_uchroot_workaround_steps():
        f.addStep(step)
    f.addStep(ucompile('../vara-llvm-project/VaRA/utils/vara/builds/' + BUILD_SCRIPT,
